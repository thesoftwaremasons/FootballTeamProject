    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Team", x => x.PId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfile", x => x.PId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    userPId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    teamPId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EnteredBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTeam", x => x.PId);
                    table.ForeignKey(
                        name: "FK_UserTeam_Team_teamPId",
                        column: x => x.teamPId,
                        principalTable: "Team",
                        principalColumn: "PId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTeam_UserProfile_userPId",
                        column: x => x.userPId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTeam_teamPId",
                table: "UserTeam",
                column: "teamPId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTeam_userPId",
                table: "UserTeam",
                column: "userPId");
        }
